    ...
    <footer className="bg-gray-50 border-t mt-auto py-6">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex flex-wrap justify-center gap-3 text-xs text-gray-500">
          <a href="/guide" className="hover:text-[#2d6ac4] transition font-medium">📚 Guide d'utilisation</a>
          <span className="text-gray-300">•</span>
          <a href="/legal/alur" className="hover:text-[#2d6ac4] transition">Loi ALUR</a>
          <span className="text-gray-300">•</span>
